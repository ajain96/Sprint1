    ...
    public class JWTManagerRepository : IJWTMangerRepository
    {
        ...
        public Tokens Authenicate(LoginViewModel registerViewModel, bool IsRegister)
        {
            ...
            if (IsRegister)
            {
                ...
                tblLogin.UserName = (string)registerViewModel.UserName;
                tblLogin.Password = (string)registerViewModel.Password;
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                new Claim((string)(string)(string)ClaimTypes.Name,(string)registerViewModel.UserName)
                }),
